...
To build the final jar and optimize the website application for production, run:
...
For example, to start a false database in a docker container, run:

```
docker-compose -f src/main/docker/false.yml up -d
```

To stop it and remove the container, run:

```
docker-compose -f src/main/docker/false.yml down
```
